...
Головна мета, щоб застосунок не втрачав дані після виходу із застосунку та при запуску відновлював їх з файлу. Повинна зберігатися адресна книга.
...
Ці приклади допоможуть у реалізації  завдання.
Критерії оцінювання:
